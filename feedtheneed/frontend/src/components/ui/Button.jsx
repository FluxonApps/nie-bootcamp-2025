...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:shadow-md",
    {
        variants: {
            variant: {
                ...
                outline: "border border-input hover:bg-accent hover:text-accent-foreground hover:border-accent hover:scale-[1.02]",
                ...
                warning: "bg-warning text-warning-foreground hover:bg-warning/90 hover:scale-[1.02]",
                danger: "bg-error text-error-foreground hover:bg-error/90 hover:scale-[1.02]",
            },
            size: {
